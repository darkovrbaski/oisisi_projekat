...
public class DodajPredmetDialog extends JDialog {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 1947524410282711272L;
	...
	private DocumentListener documentListener = new DocumentListener() {
		...
		public void removeUpdate(DocumentEvent e) {
			if (PredmetController.getInstance().proveriPopunjenostPolja()) {
	...
	public DodajPredmetDialog() {
		...
		super(Frame.getInstance(), "Dodavanje predmeta", true);
		...
		btnPotvrdi.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (PredmetController.getInstance().proveriPredmet() == true) {
					dispose();
				}
			}
		});
